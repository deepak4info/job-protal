          ...
          <Row>
            <Col xs={12} className="text-center">
              ...
              <div className="d-flex align-items-center justify-content-center">
                ...
                <GitHubButton
                  className="mt-lg-2"
                  href="https://github.com/themesberg/Dinary-react-dashboard"
                  data-size="large"
                  data-show-count="true"
                  aria-label="Star themesberg/Dinary-react-dashboard on GitHub"
                >
                  Star
                </GitHubButton>
              </div>
        ...
        <Container>
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <p className="mb-4">
                Dinary React is an admin dashboard template that is built using
  ...
  <Button variant="primary" className="m-1">Primary</Button>
          ...
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <Button
                href="https://demo.themesberg.com/Dinary-pro-react/#/map"
                className="me-3"
                variant="secondary"
                target="_blank"
              >
              ...
              <Button
                href="https://demo.themesberg.com/Dinary-pro-react/#/plugins/map"
                variant="outline-primary"
                target="_blank"
              >
          ...
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5}>
              ...
              <Button
                href="https://demo.themesberg.com/Dinary-pro-react/#/calendar"
                className="me-3"
                variant="secondary"
                target="_blank"
              >
              ...
              <Button
                href="https://demo.themesberg.com/Dinary-pro-react/#/plugins/calendar"
                variant="outline-primary"
                target="_blank"
              >
                <FontAwesomeIcon icon={faBook} className="me-2" /> Guide
          ...
          <Row className="justify-content-between align-items-center">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <p className="mb-4">
                Dinary React is built using the latest version of Bootstrap 5
          ...
          <Row className="justify-content-center mb-5 mb-lg-6">
            <Col xs={12} className="text-center">
              ...
              <p className="lead px-lg-10">
                Every page from Dinary has been carefully built to provide all
                the necessary pages your startup will require
              </p>
            </Col>
          </Row>
          <Row className="mb-5">
        ...
        <Container>
          <Row>
            <Col xs={12} lg={8}>
              ...
              <p className="lead mb-4 me-lg-6">
                ...
                out the premium version of Dinary React Dashboard in the
          ...
          <Row className="mt-6">
            <Col xs={12} md={6} lg={4} className="mb-5 mb-lg-0">
              <Card border="light" className="p-4">
                ...
                <Button
                  href="https://themesberg.com/product/dashboard/Dinary-react"
                  target="_blank"
                  variant="primary"
            ...
            <Col xs={12} md={6} lg={4} className="mb-5 mb-lg-0">
              <Card border="light" className="p-4 py-5 mt-lg-n5">
                ...
                <Button
                  href="https://demo.themesberg.com/Dinary-pro-react/#/"
                  target="_blank"
                  variant="secondary"
                  className="w-100 m-0 mt-3"
                >
                  Demo Dinary React Pro{" "}
                  <FontAwesomeIcon icon={faExternalLinkAlt} className="ms-1" />
                </Button>
              </Card>
            </Col>
          ...
          <Row className="mt-lg-6">
            <Col xs={12} className="text-center">
              ...
              <div>
                <Card.Link
                  href="https://themesberg.com/product/admin-dashboard/Dinary-bootstrap-5-dashboard"
                  target="_blank"
                  className="me-3"
                >
                  <OverlayTrigger
        ...
        <Container>
          <Row>
            <Col md={4}>
              ...
              >
                <Image src={ReactHero} />
                <span className="ms-2 brand-text">Dinary React</span>
              </Navbar.Brand>
              <p>
                Dinary React is a free and open source admin dashboard template
