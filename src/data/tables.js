...
const pageEmpolyer = [
    { id: 1,  CompanyName: 'IT shimla', CompanyStream	: 'Rajesh', EmpolyerName: 'kalu', Gender: "male" , Status:'Actice'},
    { id: 2,CompanyName: 'IT shimla', CompanyStream: 'Rajesh', EmpolyerName: 'sonu', Gender: "male" ,Status:'Actice' },
    { id: 3, CompanyName: 'IT shimla', CompanyStream: 'sunil', EmpolyerName: 'ram', Gender: "male" ,Status:'in-Actice'},
    { id: 4, CompanyName: 'IT shimla', CompanyStream: 'sonu', EmpolyerName: 'syam', Gender: "male"  ,Status:'in-Actice'},
    { id: 5, CompanyName: 'IT shimla', CompanyStream: 'sonu', EmpolyerName: 'ram', Gender: "male" ,Status:'Actice' }
];
